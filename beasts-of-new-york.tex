...
\settrims{0pt}{0pt}
\settypeblocksize{*}{5.6in}{1.40}
\setlrmargins{0.2in}{*}{*}
\setulmargins{*}{0.2in}{*}
\setheadfoot{0.3in}{0.1in}
...
\renewcommand{\tiny}{\fontsize{16}{20}\selectfont}
\renewcommand{\scriptsize}{\fontsize{18}{22}\selectfont}
\renewcommand{\footnotesize}{\fontsize{20}{24}\selectfont}
\renewcommand{\small}{\fontsize{22}{26}\selectfont}
...
\renewcommand{\huge}{\fontsize{32}{38}\selectfont}
\renewcommand{\Huge}{\fontsize{34}{41}\selectfont}
\renewcommand{\HUGE}{\fontsize{36}{43}\selectfont}
\newcommand{\giant}{\fontsize{40}{48}\selectfont}
\newcommand{\Giant}{\fontsize{44}{53}\selectfont}
...
\makechapterstyle{ebook}{%
  ...
  \renewcommand{\chapnumfont}{\normalfont\LARGE\bfseries\titlefont}
...
\begin{titlingpage}
  ...
  \posttitle{\normalcolor{}}
  \preauthor{%
    \vspace*{300pt}\par\noindent\hspace*{250pt}%
    \color{white}\titlefont\giant%
  }
  \postauthor{\normalcolor{}}
  \begin{textblock}{}(0,0)
    \noindent\includegraphics{../../../images/head.png}
  \end{textblock}
  \begin{textblock}{}(6.9,9.9)
    \noindent\includegraphics{../../../images/tail.png}
  \end{textblock}
  \maketitle
\end{titlingpage}
...
Jumper pulled himself up on his fore\-legs. Patch could see he was in
great pain.
...
rats. Redeye seem\-ed more rat than squirrel as he tore at Jump\-er’s body
...
squirrel Redeye had betrayed Jump\-er to rats, helped to kill him,
...
he want\-ed to hurry to make sure they could get back before night.
\end{tolerant}
...
\begin{tolerant}{5000}
“I am Karmerruk,” the hawk said proud\-ly. “Now tell me, what have you
...
surrounded Patch. Karmerruk turned his back to Patch, fold\-ed his
...
\begin{tolerant}{5000}
The talons that gripped Patch’s flesh seem\-ed to stab at him with
...
with hunger. The morning was very quiet. The tall grass\-es he had slept
...
How else, he asked himself, could Kar\-merruk have found him and
...
“I don’t suppose you know a hawk nam\-ed Karmerruk.”
...
\begin{tolerant}{5000}
“But their needs are so great. A traitor\-ous pretender sits on my
...
“I can’t climb down a wall!” Zelina reek\-ed of terror.
...
its massive body against the wood\-en fence and Zelina began to rock
...
\begin{tolerant}{5000}
Zelina looked north, towards the rust\-ling sounds; then south, where
...
\begin{tolerant}{5000}
At some point the death machine stop\-ped, its back was opened, and
...
which the blood-smell rose. The blood was actually visible, smear\-ed in
...
humans through the Center Kingdom; this cat look\-ed nearly as
...
\begin{tolerant}{5000}
He pushed his cage door open and climb\-ed the wire mesh onto Talis’s
...
like Patch had suggested. After a moment Patch sigh\-ed and ran after
...
deliberately turn\-ed her back on the cat she faced and walked slowly
...
\begin{tolerant}{5000}
Something white-hot burned into Pat\-ch’s left hindleg. He screamed and
...
interior, lined with benches occupied by a few slum\-ped humans.
\end{tolerant}
...
dizzy. He was only barely aware that above them the sky was streak\-ed
...
Great Avenue. But also, faintly, in the western breeze, Patch smell\-ed
...
\begin{tolerant}{5000}
“Someone else?” Karmerruk was offend\-ed. “I give you the opportunity to
...
\begin{tolerant}{5000}
Patch hesitated a moment, then plung\-ed into the grassy undergrowth,
...
even black\-er than those Patch had seen in the Hidden Kingdom, so dark
...
more than a few heartbeats knows your favour\-ite food is tulip bulbs.”
\end{tolerant}
...
\begin{tolerant}{5000}
“Patch!” Twitch bellowed, as Patch roll\-ed groggily to his feet. “It’s
...
\begin{tolerant}{5000}
“Wait!” Longtail gasped, as they approach\-ed the great oak. “Wait, you
...
\begin{tolerant}{5000}
Silver stopped in mid-sentence and turn\-ed towards Patch. She stood
...
big red squirrel next to him who spoke. He sound\-ed amused. “You didn’t
...
not attacked. They might still invade at any moment; but that pros\-pect
...
branch beside him. Patch launch\-ed himself at it, fangs bared — and
...
\begin{tolerant}{5000}
“Not necessarily,” White said. “The black\-blood-bitten sleep for days
...
\begin{tolerant}{5000}
Patch dropped to the ground and charg\-ed. He was doomed; everything he
...
\begin{tolerant}{5000}
“Bloody moon and darkened sun!” Kar\-merruk cursed, wheeling around in a
...
were not so large, and did not move with such speed and liquid
grace\nolinebreak{} —
...
moisture, and the muck beneath Patch’s paws became damp and then wet. He
...
was the source of that awful scent. He scream\-ed and jumped away, but
...
\begin{tolerant}{5000}
“You go first,” Patch said. “You’re small\-er. If I get stuck, maybe you
can get out.”
\end{tolerant}
...
cork\-screws. Patch half-paddled, half-clawed at its sides, propelling
...
\begin{tolerant}{5000}
He scrabbled with all his leaking stren\-gth to push himself through,
...
suddenly swell\-ed and became deafening, and the earth itself began to
...
“Maybe,” the rat said doubtfully. It sigh\-ed. “I envy you your names. I
wish I had a name.”
...
approach\-ed and discovered it was a hulk of rotting wood, human-carved
...
Patch, coming close enough to recognize. Patch blink\-ed with
...
Beneath launch\-ed itself completely out of the water and onto the stone
...
\begin{tolerant}{5000}
“Bird?” A series of rattling moans emer\-ged from the darkness. It took
...
\begin{tolerant}{10000}
Patch sniffed. She was right. And rust\-ling sounds were coming from
...
multi\-colour\-ed double helix trapped within.
\end{tolerant}
...
\begin{tolerant}{5000}
The hawk thought a moment, then sigh\-ed. “I do like mice … I see your
...
\begin{tolerant}{5000}
“I don’t know anything!” Daffa squawk\-ed nervously.
\end{tolerant}
...
but it sound\-ed like it was, yes, he heard squirrels crying with rage
...
\begin{tolerant}{5000}
But escape was not his intention. Kar\-merruk suddenly turned in a
...
\begin{tolerant}{5000}
“\emph{Coyote,}” Siva echoed, and the tiger roil\-ed beneath Patch,
...
\begin{tolerant}{5000}
The tiger landed clawing atop the cai\-man’s hind\-quarters; the caiman
...
\begin{tolerant}{5000}
The King Beneath had an extra appen\-dage; its powerful tail. It used
...
Sniffer at the 8th Street\textsc{/nyu} subway station. He and the cats escaped
the rats on the \textsc{n/r}, and rode it all the way to the 59th Street
...
\href{http://www.katewardtv.com/}{Kate Ward} for all her support and
belief.

Chelsea Watt and \href{http://www.elisakorenne.com/}{Elisa Korenne}
for providing the \textsc{nyc} apartments in which I started and finished
the book.

Linda Tom for designing \href{http://www.elisakorenne.com/}{the
  website}.

\href{http://www.sarahlangan.com/}{Sarah Langan} for exploring the
Croton Road with me.

Maggie Cino and my sisters, Alison and Jennifer, for reading early
versions.

Julia Solis for her book \href{http://www.newyorkunderground.org/}{New
  York Underground}.

L.B. Deyo for his(?) book
\href{http://www.amazon.com/Invisible-Frontier-Exploring-Tunnels-Rooftops/dp/0609809318/}{%
  Invisible Frontier}.

Temple Grandin for her book
\href{http://www.grandin.com/inc/animals.in.translation.html}{%
  Animals in Translation}.

Robert Sullivan for his book
\href{http://www.amazon.com/Rats-Observations-History-Unwanted-Inhabitants/dp/1582343853}{%
  Rats: Observations on the History and Habitat of the City's Most
  Unwanted Inhabitants}.

Edwin G. Burrows and Mike Wallace for their book
\href{http://www.amazon.com/Gotham-History-York-City-1898/dp/0195116348}{%
  Gotham: A History of New York City to 1898}.

\href{http://www.davewellington.net/}{David Wellington} and
\href{http://www.antipope.org/charlie/}{Charles Stross} for their
helpful advice.

\href{http://sfllaw.ca/~sfllaw/}{Simon Law} for typesetting this
\textsc{pdf} edition. (The
\href{http://github.com/sfllaw/beasts-of-new-york}{\LaTeX{} source} is
available on GitHub, for those who want to roll their own.)
